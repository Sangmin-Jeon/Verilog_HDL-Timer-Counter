...
# Bank 34
set_property PACKAGE_PIN R8  [get_ports {signalout[0]    }];  # "R8.ARDUINO_IO0"
set_property PACKAGE_PIN P8  [get_ports {signalout[1]    }];  # "P8.ARDUINO_IO1"
set_property PACKAGE_PIN P9  [get_ports {signalout[2]    }];  # "P9.ARDUINO_IO2"
set_property PACKAGE_PIN R7  [get_ports {signalout[3]    }];  # "R7.ARDUINO_IO3"
set_property PACKAGE_PIN N7  [get_ports {signalout[4]    }];  # "N7.ARDUINO_IO4"
set_property PACKAGE_PIN R10 [get_ports {signalout[5]    }];  # "R10.ARDUINO_IO5"
set_property PACKAGE_PIN P10 [get_ports {signalout[6]    }];  # "P10.ARDUINO_IO6"
set_property PACKAGE_PIN N8  [get_ports {signalout[7]    }];  # "N8.ARDUINO_IO7"
set_property PACKAGE_PIN M9  [get_ports {digit[0]    }];  # "M9.ARDUINO_IO8"
set_property PACKAGE_PIN N9  [get_ports {digit[1]    }];  # "N9.ARDUINO_IO9"
set_property PACKAGE_PIN M10 [get_ports {digit[2]   }];  # "M10.ARDUINO_IO10"
set_property PACKAGE_PIN M11 [get_ports {digit[3]   }];  # "M11.ARDUINO_IO11"
